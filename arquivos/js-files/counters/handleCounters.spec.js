import { counters, originalCounters } from './handleCounters.js';
...
describe('testing counters', () => {
  ...
  test('should be able to have the same counter instance in 2 different variables', () => {
    const counter1 = originalCounters();
    const counter2 = counter1;
    expect(counter1 === counter2).toBeTruthy();
  })

  test('should be able to acsess the same counters in different variables.', () => {
    const counter1 = originalCounters();
    const counter2 = counter1;
